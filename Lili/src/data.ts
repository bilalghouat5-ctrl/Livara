...
export const initialListings: Listing[] = [
  ...
  },
  {
    ...
    category: 'chalets',
    title: {
      ar: 'شاليه الأرز السويسري الدافئ - حديقة الشريعة الوطنية البليدة',
      fr: 'Chalet de Cèdres "Suisse Sauvage" - Parc National Chréa Blida',
      en: 'Swiss-Style Alpine Cedar Wood Chalet - Chréa National Park Blida',
      kab: 'Axxam n wedrar Chréa - Blida'
    },
    description: {
      ar: 'شاليه خشبي كلاسيكي فاخر يقع وسط أشجار الأرز الأطلسي النادرة في جبال الشريعة بولاية البليدة. يتميز بموقد دافئ وجلسة هادئة وإطلالة بانورامية ساحرة على المنحدرات الجبلية المغطاة بالثلوج شتاءً والغيوم صيفاً. دافئ ومريح للعائلات والمجموعات.',
      fr: 'Chalet alpin traditionnel en bois massif niché au coeur de la célèbre forêt de cèdres de Chréa, Blida. Dispose d’une grande cheminée en pierre et d’une vue splendide sur les monts enneigés.',
      en: 'Genuine wooden mountain chalet located inside the majestic Chréa National Park, Blida. Includes a rustic stone fireplace and panoramic outdoor decking overlooking snowy mountain tops.',
      kab: 'Axxam n wedrar Chréa, Blida s taxammt n dican.'
    },
    location: {
      ar: 'الشريعة، البليدة',
      fr: 'Parc National de Chréa, Blida',
      en: 'Chrea National Park, Blida',
      kab: 'Chréa, Blida'
    },
    wilaya: 'Blida',
    pricePerNight: 19500,
    ...
    hostName: 'ياسين بلعيدي',
    hostImage: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=100&q=80',
    beds: 4,
    bathrooms: 2,
    guests: 6,
    features: {
      ar: ['موقد حطب دافئ متكامل مع حطب مجاني', 'إطلالة جبلية بانورامية ساحرة', 'شرفة واسعة ومكان للشواء', 'إنترنت لاسلكي وتلفزيون ذكي'],
      fr: ['Véritable cheminée à bois avec bûches', 'Vue panoramique sur la montagne', 'Grande terrasse avec barbecue', 'Wi-Fi haut débit & Smart TV'],
      en: ['Cozy stone fireplace (wood included)', 'Breathtaking alpine panoramic view', 'Spacious terrace with barbecue station', 'Hi-speed Wi-Fi and Smart TV set'],
      kab: ['Cheminée']
    },
    reviews: []
  },
  {
    ...
    category: 'pools',
    title: {
      ar: 'فيلا الياسمين مع مسبح خاص مغلق تماماً للعائلات بالبليدة',
      fr: 'Villa Jasmin - Piscine Privée Intime sans vis-à-vis Blida',
      en: 'Villa Jasmine - Highly Gated Private Swimming Pool Blida',
      kab: 'Villa Jasmin Blida s yimsirigen n waman'
    },
    description: {
      ar: 'فيلا ريفية حديثة محاطة بأشجار الحمضيات والورود في البليدة، تحتوي على حوض مسبح خاص كبير ونظيف ومحمي كلياً من الجيران للحصول على خصوصية عائلية تامة. مجهزة بجميع وسائل الراحة الحديثة وشواية وجلسة للاسترخاء.',
      fr: 'Magnifique villa contemporaine avec piscine extérieure privée sans vis-à-vis, idéale pour les familles locales à Blida. Entourée de vergers parfumés et équipée de terrasses de repos.',
      en: 'Fabulous contemporary villa featuring a gated private pool with 100% security and privacy for local families. Nested in the citrus orchards of Blida.',
      kab: 'Villa Jasmin, Blida s yimsirigen.'
    },
    location: {
      ar: 'قرواو، البليدة',
      fr: 'Guerrouaou, Blida',
      en: 'Guerrouaou, Blida',
      kab: 'Guerrouaou, Blida'
    },
    wilaya: 'Blida',
    pricePerNight: 28000,
    rating: 4.88,
    ...
    hostName: 'عبد الحميد فريد',
    hostImage: 'https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?auto=format&fit=crop&w=100&q=80',
    beds: 5,
    bathrooms: 3,
    guests: 8,
    features: {
      ar: ['مسبح عائلي بخصوصية 100%', 'حديقة محاطة بأشجار البرتقال والياسمين', 'شواية فحم حديثة مع مستلزماتها', 'تكييف هواء مركزي كامل'],
      fr: ['Piscine privée 100% intime', 'Grand jardin d’orangers et jasmin', 'Barbecue ultra-moderne inclus', 'Climatisation centrale partout'],
      en: ['100% Gated private family pool', 'Scented garden of orange & jasmine trees', 'Full charcoal barbecue suite', 'Central heating & air conditioning'],
      kab: ['Pool']
    },
    reviews: []
  },
  {
    ...
    category: 'wedding_halls',
    title: {
      ar: 'قاعة الورود الملكية للأفراح والمناسبات السعيدة بالبليدة',
      fr: 'Palais des Roses - Salle des Fêtes Impériale Blida',
      en: 'Royal Rose Palace - Grand Imperial Wedding Hall Blida',
      kab: 'Tixammt n tmeghriwin Palais des Roses - Blida'
    },
    description: {
      ar: 'أرقى قاعات الحفلات في مدينة الورود البليدة، تتسع لأكثر من 400 مدعو مع تجهيزات صوتية وإضاءة ليزر عالمية وتصميم داخلي فاخر وجناح راقٍ للعروس تصفيف واستراحة بخصوصية تامة.',
      fr: 'La plus somptueuse salle des fêtes de la ville des roses Blida, accueillant jusqu’à 400 convives. Un cadre royal, des lustres raffinés et une suite de transition pour la mariée.',
      en: 'The most luxury event palace in the City of Roses (Blida). Accommodates up to 400 guests with fine crystal chandeliers, professional acoustic hardware, and private suite.',
      kab: 'Tixammt n tmeghriwin Palais des Roses, Blida.'
    },
    location: {
      ar: 'وسط المدينة، البليدة',
      fr: 'Blida Centre, Blida',
      en: 'Downtown Blida, Blida',
      kab: 'Blida Centre'
    },
    wilaya: 'Blida',
    pricePerNight: 75000,
    ...
    hostName: 'الحاج مصطفى الوردي',
    hostImage: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&q=80',
    beds: 1,
    bathrooms: 4,
    guests: 400,
    features: {
      ar: ['سعة كبرى تصل لـ 400 ضيف', 'جناح ملكي خاص بالعروس مكيف بالكامل', 'نظام صوتي مجسم وإضاءة ملونة ساحرة', 'مواقف محروسة تتسع لـ 100 سيارة'],
      fr: ['Capacité jusqu’à 400 invités', 'Suite royale climatisée pour la mariée', 'Sonorisation d’ambiance et effets pro', 'Parking fermé sécurisé (100 voitures)'],
      en: ['Large capacity up to 400 VIP guests', 'Air-conditioned royal bridal suite', 'Stereo acoustics & dynamic laser lights', 'Secure parking holds up to 100 vehicles'],
      kab: ['Wedding Hall']
    },
    reviews: []
  },
  {
    ...
    category: 'trending',
    title: {
      ar: 'شقة أندلسية ساحرة بوسط مدينة البليدة الهادئة',
      fr: 'Appartement Andalou de Prestige - Blida Centre',
      en: 'Charming Andalusian Estate - Quiet Central Blida',
      kab: 'Axxam Andalou - Blida'
    },
    description: {
      ar: 'شقة بطابع أندلسي أصيل تقع بوسط مدينة البليدة، مجهزة بالكامل ومريحة جداً لإجازتكم أو زيارتكم العائلية. تصميم داخلي من الفخار والنقش الأندلسي الجميل وهدوء تام.',
      fr: 'Superbe appartement de style néo-andalou situé au coeur de Blida. Décorations raffinées, carrelage traditionnel émaillé et calme absolu.',
      en: 'Elegantly furnished Andalusian-style apartment located in Blida downtown. Features cultural handcarved details, complete privacy and absolute comfort.',
      kab: 'Axxam Andalou deg wammas n Blida.'
    },
    location: {
      ar: 'وسط المدينة، البليدة',
      fr: 'Centre Ville, Blida',
      en: 'Downtown Blida, Blida',
      kab: 'Blida Centre'
    },
    wilaya: 'Blida',
    ...
    hostName: 'نسيم بوعافية',
    hostImage: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=100&q=80',
    beds: 3,
    bathrooms: 1,
    guests: 4,
    features: {
      ar: ['طابع ديكور أندلسي جزائري عتيق', 'قرب تام من الأسواق الشعبية ومقاهي المدينة', 'مطبخ عائلي مجهز بكامل الأدوات', 'تكييف هواء وإنترنت فائق السرعة'],
      fr: ['Style andalou traditionnel unique', 'Proximité immédiate des marchés de Blida', 'Cuisine équipée neuve complète', 'Climatisation & Wi-Fi ultra-rapide'],
      en: ['Traditional Andalusian-Algerian theme', 'Walking distance to local cultural markets', 'Fully-furnished kitchen spaces', 'Full air conditioning & high-speed Wi-Fi'],
      kab: ['Al-Andalous']
    },
    reviews: []
  },
  {
    ...
    category: 'recently_listed',
    title: {
      ar: 'منزل ريفي دافئ مطل على مزارع المتيجة - البليدة',
      fr: 'Gîte Rural de Charme sur la Plaine - Blida',
      en: 'Cozy Countryside Ranch House - Mitidja Blida',
      kab: 'Axxam n tferka - Blida'
    },
    description: {
      ar: 'منزل ريفي خشبي حديث يقع على أطراف البليدة يوفر إقامة هادئة وهواء نقي وسط مزارع المتيجة الخصبة، مثالي للاسترخاء والتمتع بالطبيعة الرائعة بصحبة العائلة.',
      fr: 'Maisonnette de campagne rustique entourée de vergers au pied de l’Atlas de Blida. Air frais, tranquillité et confort moderne à la ferme d’oranges.',
      en: 'Charming cottage nestled in the farming flatlands of Blida. Enjoy organic country breeze, private garden zones, and full premium amenities.',
      kab: 'Axxam n tferka deg uzaɣaer n Blida.'
    },
    location: {
      ar: 'سهل متيجة، البليدة',
      fr: 'Plaine de la Mitidja, Blida',
      en: 'Mitidja Plains, Blida',
      kab: 'Mitidja, Blida'
    },
    wilaya: 'Blida',
    pricePerNight: 12000,
    ...
    hostName: 'عمي الهادي بوقرة',
    hostImage: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?auto=format&fit=crop&w=100&q=80',
    beds: 4,
    bathrooms: 2,
    guests: 6,
    features: {
      ar: ['جو ريفي هادئ مع هواء صحي نقي', 'إطلالة مباشرة على جبال الأطلس البليدي', 'وجبة إفطار ريفية مجانية صباحاً', 'مدفأة غاز مريحة ومطبخ كامل'],
      fr: ['Ambiance champêtre calme et ressourçante', 'Vue imprenable sur l’Atlas de Blida', 'Petit-déjeuner du terroir offert', 'Chauffage gaz sécurisé & cuisine équipée'],
      en: ['Serene rural workspace & clean air', 'Unobstructed view of Blida mountain range', 'Complimentary fresh country breakfast', 'Gas fireplace & fully fitted kitchen'],
      kab: ['Axxam n tferka']
    },
    reviews: []
  },
  {
    ...
    category: 'pools',
    title: {
      ar: 'فيلا كناستيل الملكية المطلة على البحر بمسبح لانهائي - وهران',
      fr: 'Villa Royale Canastel - Piscine Suspendue sur Mer Oran',
      en: 'Royal Canastel Oceanfront Villa & Private Infinity Pool Oran',
      kab: 'Villa Canastel m yimsirigen n waman deg wehran'
    },
    description: {
      ar: 'فيلا ديلوكس في حي كناستيل الراقي بوهران، تتميز بمسبح إنفينيتي ساحر معلق يطل مباشرة على البحر الأبيض المتوسط بخصوصية عائيلة تامة 100% وجاردن رائع مهيأ بالكامل للشواية.',
      fr: 'Splendide villa d’architecte surplombant la falaise de Canastel, Oran. Offre une magnifique piscine à débordement suspendue au-dessus de la mer et sans vis-à-vis.',
      en: 'Breathtaking designer villa built on the legendary cliffside of Canastel, Oran. Features an spectacular oceanfront infinity pool designed with absolute privacy.',
      kab: 'Villa Canastel deg wehran, yelhane s liser.'
    },
    location: {
      ar: 'كناستيل، وهران',
      fr: 'Falaise de Canastel, Oran',
      en: 'Canastel Cliff, Oran',
      kab: 'Canastel, Oran'
    },
    wilaya: 'Oran',
    pricePerNight: 38050,
    ...
    hostName: 'رياض الباهي',
    hostImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80',
    beds: 6,
    bathrooms: 4,
    guests: 10,
    features: {
      ar: ['مسبح إنفينيتي خارجي معلق على البحر', 'خصوصية تامة وعائلية 150% بدون مقابل جيران', 'نظام صوت محيطي خارجي و شواية فحم', 'حراسة وحي راق للغاية في كناستيل'],
      fr: ['Piscine à débordement suspendue face mer', 'Absence totale de vis-à-vis (100% intime)', 'Système audio Bose et barbecue de luxe', 'Quartier hautement sécurisé à Canastel'],
      en: ['Hanging infinity pool facing the sea', '100% Gated family privacy (No overlook)', 'Outer Bose sound system & designer grill', 'Highly secure high-end Canastel residential'],
      kab: ['Oceanfront Pool']
    },
    reviews: []
  },
  {
    ...
    category: 'wedding_halls',
    title: {
      ar: 'قصر جوهرة الغرب للأفراح والاحتفالات الكبرى - وهران',
      fr: 'Palais "Joyau du West" - Grande Salle des Fêtes Oran',
      en: 'Jewel of the West Palace - Exhibition & Wedding Venue Oran',
      kab: 'Palais Joyau du West - Oran'
    },
    description: {
      ar: 'قصر الحفلات الأسطوري في وهران الباهية يتسع لما يصل إلى 500 مدعو مع زينة الكريستال الفاخرة مجهزة بليزر ثلاثي الأبعاد ومنسق أغاني وفريق خدمة محترف لاستقبل حفلاتكم بكل فخر.',
      fr: 'Prestigieux palais de réception situé à Oran Occidentale, pouvant accueillir jusqu’à 500 prestigieux invités. Design d’honneur, lustres de cristal, traiteur haut de gamme.',
      en: 'Revered wedding ballroom located in Oran, planning standard and luxury events for up to 500 guests. Complete setup with intelligent lighting and dynamic laser suite.',
      kab: 'Tixammt n tmeghriwin deg wehran.'
    },
    location: {
      ar: 'سنية، وهران',
      fr: 'Es-Senia, Oran',
    ...
    hostName: 'أمين البهجاوي',
    hostImage: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=100&q=80',
    beds: 1,
    bathrooms: 5,
    guests: 500,
    features: {
      ar: ['سعة تصل لـ 500 شخص', 'منسق دي جي محترف ونظام ليزر مذهل', 'خدمة الضيافة وصناعة الشاي وحلويات الباهية', 'شاشات عرض ليد عملاقة بممرات الدخول'],
      fr: ['Capacité d’accueil géante (500 pers)', 'DJ résident et effets laser d’exception', 'Équipe de traiteurs et de serveurs vêtus', 'Écrans LED haute résolution intégrés'],
      en: ['Vast capacity up to 500 seated visitors', 'Integrated professional DJ booth & laser', 'Premium catering and custom catering staff', 'Giant LED screens along entry corridors'],
      kab: ['Oran Wedding']
    },
    reviews: []
  },
  {
    ...
    category: 'summer_houses',
    title: {
      ar: 'دوبلكس شاطئي فاخر مطل مباشرة على ساحل مداغ الذهبي - وهران',
      fr: 'Duplex Pieds-dans-l’eau de Standing - Plage Madagh Oran',
      en: 'Premium Beachfront Waterfront Duplex - Golden Madagh Oran',
      kab: 'Duplex Madagh, wehran'
    },
    description: {
      ar: 'استيقظ على رنين أمواج البحر الهادئة في هذا الدوبلكس الشاطئي الفاخر بموقع خلاب في مداغ وهران، مع مدخل مباشر للشاطئ وشرفة واسعة وجلسة صيفية رائعة لمشاهدة الغروب.',
      fr: 'Réveillez-vous face au bruit des vagues dans ce luxueux duplex familial situé sur la plage vierge de Madagh à Oran. Terrasse exceptionnelle avec vue infinie et accès direct au rivage.',
      en: 'Wake up to the gentle waves in this high-end beach duplex on Madagh coast, Oran. Outstanding private sea views, modern lounge layouts, and immediate shoreline entry.',
      kab: 'Duplex Madagh deg wehran radd lebhər.'
    },
    location: {
      ar: 'شاطئ مداغ، وهران',
      fr: 'Plage de Madagh, Oran',
      en: 'Madagh Beach, Oran',
      kab: 'Madagh, Oran'
    },
    wilaya: 'Oran',
    pricePerNight: 22000,
    ...
    hostName: 'نور الدين بلال',
    hostImage: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80',
    beds: 5,
    bathrooms: 2,
    guests: 8,
    features: {
      ar: ['مدخل مباشر فوري إلى شاطئ رملي نظيف', 'شرفة شاطئية واسعة مع شواية', 'أسرَّة مريحة وتكييف في كل الغرف', 'إنترنت مجاني وموقف سيارات محروس'],
      fr: ['Accès direct plage de sable fin', 'Grande terrasse face mer avec barbecue', 'Climatisation autonome dans toutes les pièces', 'Connexion Wi-Fi & parking gardé d’été'],
      en: ['Walk-in access to soft sandy beach shore', 'Vast oceanfront terrace with modern grill', 'Independent air conditioning in each room', 'Full Wi-Fi access and gated guest parking'],
      kab: ['Beachfront Duplex']
    },
    reviews: []
  },
  {
    ...
    category: 'trending',
    title: {
      ar: 'شقة لوفت عصرية بشرفة عملاقة مطلة على واجهة البحر بوهران',
      fr: 'Loft Contemporain vue Panoramique - Front de Mer Oran',
      en: 'Modern Luxury Loft with Deep Oceanfront Terrace Oran',
      kab: 'Loft wehran'
    },
    description: {
      ar: 'شقة لوفت حديثة جداً تقع في قلب وهران مع شرفة واسعة تطل على واجهة البحر الشهيرة، قريبة من المطاعم السياحية والمقاهي. مصممة بالكامل بمستويات عالية وتوفر إقامة مميزة.',
      fr: 'Loft d’architecte de style industriel contemporain sur le célèbre Front de Mer d’Oran. Terrasse exceptionnelle pour siroter un thé en profitant du coucher de soleil.',
      en: 'Breathtaking modern loft perched on Orans iconic Seafront Boulevard. Designed with premium furniture layouts and featuring an outstanding outdoor terrace.',
      kab: 'Loft deg wehran radd lebhər.'
    },
    location: {
      ar: 'واجهة البحر، وهران',
      fr: 'Front de Mer, Oran',
      en: 'Oceanfront Boulevard, Oran',
      kab: 'Front de Mer, Oran'
    },
    wilaya: 'Oran',
    pricePerNight: 14000,
    rating: 4.92,
    ...
    hostName: 'حميد وهراني',
    hostImage: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80',
    beds: 2,
    bathrooms: 1,
    guests: 4,
    features: {
      ar: ['موقع رائع بقلب واجهة البحر وهران', 'شرفة بانورامية خارقة تطل على الواجهة المائية', 'أثاث أوروبي حديث ومطبخ عصري متكامل', 'توفير حراسة وقفل إلكتروني رقمي ذكي للمنزل'],
      fr: ['Emplacement n°1 sur le Front de Mer', 'Vaste de balcon d’été vue port d’Oran', 'Mobilier contemporain et cuisine neuve', 'Accès sécurisé par serrure numérique'],
      en: ['Premium location on Oran Front de Mer', 'Outstanding balcony overlooking Oran Bay', 'European high-end custom furniture suite', 'Smart lock and secure premium building entry'],
      kab: ['Oran Loft']
    },
    reviews: []
  },
  {
    ...
    category: 'recently_listed',
    title: {
      ar: 'ستوديو فرنسي كلاسيكي هادئ بوسط مدينة وهران',
      fr: 'Studio Style Haussmannien - Oran Centre',
      en: 'Quiet Classic French Studio - Downtown Oran',
      kab: 'Studio wehran'
    },
    description: {
      ar: 'ستوديو بتصميم فرنسي أنيق في حي عريق بوهران، مثالي لرجال الأعمال والمسافرين الباحثين عن الهدوء والراحة بقلب المدينة القديمة والتواصل.',
      fr: 'Studio chic d’époque entièrement rénové à neuf dans le centre d’Oran. Allie la beauté de l’histoire coloniale et le confort moderne de pointe.',
      en: 'Charming restored high-ceiling apartment in Orans cultural classic district. Equipped with cozy reading corners, strong Wi-Fi and high quality comforts.',
      kab: 'Studio wehran centre.'
    },
    location: {
      ar: 'وسط المدينة، وهران',
      fr: 'Centre Ville, Oran',
    ...
    hostName: 'سارة الكسندري',
    hostImage: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=100&q=80',
    beds: 1,
    bathrooms: 1,
    guests: 2,
    features: {
      ar: ['كلاسيكي سقف مرتفع وتصميم فرنسي عتيق', 'إنترنت لاسلكي فائق ومكتب عمل مريح', 'قريب من كل وسائل النقل العام بوسط المدينة', 'مشروبات قهوة إسبريسو ترحيبية مجانية'],
      fr: ['Hauteur sous plafond d’époque coloniale', 'Wi-Fi pro idéal télétravail ou affaires', 'Proche de tous transports et métros', 'Machine à expresso et dosettes offertes'],
      en: ['Heritage high-ceilings French architecture', 'Highly stable Wi-Fi and desk areas', 'Immediate access to local trains & cabs', 'Complimentary premium espresso welcome pod'],
      kab: ['Oran Studio']
    },
    reviews: []
  },
  {
    ...
    category: 'summer_houses',
    title: {
      ar: 'بنجالو الواحة الشاطئية - شواطيء كوردون الأزرق بتيبازة',
      fr: 'Bungalow Mer "Le Cordon Bleu" - Tipaza',
      en: 'Beach Oasis Bungalow - Tipaza Marine Coast',
      kab: 'Bungalow Tipaza radd lebhər'
    },
    description: {
      ar: 'بنغالو عائلي خشبي ساحر يفتح مباشرة على رمال شاطئ العقد الأزرق في تيبازة، محاط بحديقة صنوبر ملطفة ومثالي لقضاء العطلة الصيفية مع العائلة.',
      fr: 'Charmant bungalow en front de mer entouré de bois de pins odorants à Tipaza. Cadre zen et idyllique pour des vacances d’été inoubliables en Algérie.',
      en: 'A gorgeous seaside wooden chalet on Tipazas premium coastal lines. Shaded by Mediterranean pine trees, offering instant access to sandy shores.',
      kab: 'Bungalow Tipaza, radd lebhər.'
    },
    location: {
      ar: 'شاطئ شنوا, تيبازة',
      fr: 'Plage de Chenoua, Tipaza',
      en: 'Chenoua Beach, Tipaza',
      kab: 'Chenoua, Tipaza'
    },
    wilaya: 'Tipaza',
    pricePerNight: 16000,
    ...
    guests: 6,
    features: {
      ar: ['موقع فريد ومباشر على الشاطئ والرمال', 'حديقة صنوبر ملطفة ومجانية وممتعة للأولاد', 'نظافة حقيقية وتكييف هواء مركزي بكل بنجلو', 'جلسات ومنسوجات صيفية تحت الشمس'],
      fr: ['Accès plage direct sable doux', 'Pinède naturelle ombragée pour enfants', 'Climatisation saine et eau courante H24', 'Lits d’été extérieurs et chaises de plage'],
      en: ['Walk-out beachfront location', 'Natural shaded pine garden for kids', 'Robust A/C and fresh running water H24', 'Outdoor sun lounges and beach seating'],
      kab: ['Tipaza Bungalow']
    },
    reviews: []
  },
  {
    ...
    category: 'pools',
    title: {
      ar: 'فيلا تيبازة مارينا بمسابح متتالية على الآثار الرومانية',
      fr: 'Villa Marina Tipaza - Piscines en Cascade face ruines',
      en: 'Tipaza Marina Villa - Double Pool Complex & Seaside Ruins',
      kab: 'Villa Tipaza s yimsirigen n waman'
    },
    description: {
      ar: 'فيلا استثنائية بتصميم معاصر مطلة على البحر تقع بالقرب من الآثار الرومانية العريقة في تيبازة، تحتوي على حمام سباحة خارجي خلاب متتالي بخصوصية تامة وحوض جاكوزي دافئ لتجربة مثالية.',
      fr: 'Villa d’architecte d’exception disposant de piscines privatives en cascade, surplombant les légendaires vestiges romains de Tipaza et la Méditerranée.',
      en: 'Remarkable contemporary estate positioned alongside Tipazas world-famous Roman ruins. Hosts cascading double pools alongside private sea gates.',
      kab: 'Villa Tipaza s yimsirigen n waman.'
    },
    location: {
      ar: 'روين تيبازة، تيبازة',
      fr: 'Ruines Romaines, Tipaza',
      en: 'Roman Ruins Coast, Tipaza',
      kab: 'Tipaza'
    },
    wilaya: 'Tipaza',
    pricePerNight: 32000,
    ...
    hostName: 'فارس الماريني',
    hostImage: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80',
    beds: 5,
    bathrooms: 3,
    guests: 8,
    features: {
      ar: ['مسبح إنفينيتي متدرج بخصوصية عائلية كاملة', 'إطلالة تاريخية على البحر والآثار الرومانية بتيبازة', 'جاكوزي خارجي دافئ مجهز ومضاء ليلاً', 'نظام تحكم كامل بالأمن والأجهزة الذكية للفيلا'],
      fr: ['Piscines en cascade face mer privatitf', 'Vue directe sur les vestiges romains classés', 'Jacuzzi thérapeutique chauffé d’extérieur', 'Sécurité de pointe par gardien certifié'],
      en: ['Double cascading private swimming pool', 'Stunning unhindered historical archaeological view', 'Heated hydro-therapy spa under night sky', 'Gated estate with high-end camera security'],
      kab: ['Roman Villa Pool']
    },
    reviews: []
  },
  {
    ...
    category: 'sahara',
    title: {
      ar: 'نزل الواحة التقليدي ببني يزقن - قصر غرداية العتيق',
      fr: 'Dâr El Ouahat - Maison d’Hôtes Traditionnelle Beni Isguene',
      en: 'The Oasis Heritage Lodge - Ancient Beni Isguene Ghardaia',
      kab: 'Axxam n liser Beni Isguene Ghardaia'
    },
    description: {
      ar: 'عش سحر وادي ميزاب التاريخي في هذا النزل المبني بالمواد المحلية التقليدية في واحات بني يزقن بغرداية. غرف بطابع قصر غرداية، هدوء تام، شاي بالنعناع في السطح وإطلالة خلابة على واحة النخيل العظيمة.',
      fr: 'Plongez au coeur de la vallée millénaire du M’Zab dans cette maison d’hôtes construite en argile traditionnelle et plâtre local à Béni Isguene, Ghardaïa. Paix intérieure absolue.',
      en: 'Immersive cultural guest stay constructed using traditional Saharan sands and local earth in the historic Beni Isguene, Ghardaia (M\'Zab valley). Complete mindfulness.',
      kab: 'Axxam n liser Beni Isguene deg Ghardaia.'
    },
    location: {
      ar: 'بني يزقن، غرداية',
      fr: 'Béni Isguene, M’Zab, Ghardaïa',
      en: 'Beni Isguene, Ghardaia',
      kab: 'Beni Isguene, Ghardaia'
    },
    wilaya: 'Ghardaia',
    pricePerNight: 13500,
    rating: 4.93,
    ...
    hostName: 'عمي الحاج سليمان الميزابي',
    hostImage: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&q=80',
    beds: 6,
    bathrooms: 3,
    guests: 10,
    features: {
      ar: ['تصميم تقليدي بنقوش معمارية ميزابية فريدة', 'سطح واسع وإطلالة مباشرة على مآذن بني يزقن التاريخية', 'وجبات طعام تقليدية صحية (كسكسي، شربة ميزابية)', 'جلسة كركار صحراوية وشاي مجاني بالحطب سهرة ليلاً'],
      fr: ['Architecture traditionnelle mozarabe saine', 'Toit-terrasse panoramique sur les palmeraies', 'Dîner terroir traditionnel inclus', 'Hammam vapeur à sec traditionnel'],
      en: ['Stunning traditional Mozabite architecture', 'Spacious roof terrace over palmeraies & minarets', 'Traditional healthy Mozabite home dining', 'Saharan firewood mint-tea circles under the sky'],
      kab: ['Ghardaia Oasis']
    },
    reviews: []
  }
