...
export const BookingReviewPage: React.FC<BookingReviewPageProps> = ({
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 bg-white z-50 overflow-y-auto pb-32 flex flex-col text-right scrollbar-none rounded-t-[36px] sm:rounded-[36px]"
      dir="rtl"
    >
      ...
      <div className="fixed sm:absolute bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-zinc-100 py-4 px-6 flex flex-col items-center shadow-2xl max-w-xl mx-auto rounded-b-none sm:rounded-b-[36px]">
        <button
          type="button"
          onClick={onConfirm}
