...
export const HostMenuView: React.FC<{ onSwitchToTravel: () => void }> = ({ onSwitchToTravel }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 pt-10 pb-6 space-y-6 text-right select-none relative md:pb-28" dir="rtl">
      ...
      <div className="flex items-center justify-between font-black">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="w-10 h-10 bg-zinc-100 rounded-full flex items-center justify-center text-zinc-900 border border-zinc-200/20 hover:bg-zinc-200/65 relative cursor-pointer haptic-tap">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-[28px] p-6 text-right space-y-5.5 relative overflow-hidden shadow-xs">
              ...
              <div className="pt-1 flex justify-center">
                <button
                  ...
                  className="bg-white text-zinc-905 border border-zinc-200 hover:bg-zinc-100 text-xs font-black py-2.5 px-7 rounded-xl transition-all shadow-xs cursor-pointer haptic-tap"
                >
                  ابدأ الآن
                </button>
              </div>
      ...
      {/* Floating Action Switch Button (التبديل إلى السفر) - Floating Gently! */}
        ...
        {scrollVisible && (
          ...
          >
            <button
              ...
              type="button"
              className="bg-zinc-950 hover:bg-black transition-all text-white text-[11.5px] font-black py-3 px-6 rounded-full flex items-center justify-center gap-2 border border-zinc-800 shadow-[0_12px_24px_rgba(0,0,0,0.18)] cursor-pointer select-none whitespace-nowrap haptic-tap font-sans"
              id="switch-to-travel-floating-btn"
            >
              <ArrowLeftRight className="w-4 h-4 text-[#ff385c]" />
              <span>التبديل إلى السفر</span>
            </button>
          </motion.div>
        )}
      </AnimatePresence>
