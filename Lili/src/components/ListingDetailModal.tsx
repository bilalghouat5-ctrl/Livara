    ...
    >
      ...
      >
        ...
        >
          ...
          <button 
            onClick={onClose}
            className={`transition-all flex items-center justify-center cursor-pointer active:scale-95 border-0 rounded-full ${
              isScrolledHeader 
                ? 'bg-transparent text-zinc-950 p-2' 
                : 'bg-white/90 backdrop-blur-sm text-zinc-900 p-2.5 rounded-full shadow-md hover:bg-zinc-50'
            }`}
            ...
            type="button"
          >
            <ArrowRight className="w-5 h-5 stroke-[2.3] text-zinc-955" />
          </button>
          ...
          <div className="flex gap-3">
            ...
            <button 
              onClick={handleShareClick}
              className={`transition-all flex items-center justify-pointer cursor-pointer active:scale-95 border-0 rounded-full ${
                isScrolledHeader 
                  ? 'bg-transparent text-zinc-955 p-2' 
                  : 'bg-white/90 backdrop-blur-sm text-zinc-700 p-2.5 rounded-full shadow-md hover:bg-zinc-50'
              }`}
