...
export const ListingDetailModal: React.FC<ListingDetailModalProps> = ({ listing, onClose }) => {
  ...
  // 3-Second transition loading states with high-fidelity skeleton shimmers & ZacharyCrespin2 custom loader
  ...
  // Intercept view rendering to show elegant 3-second center-aligned clock loader from Uiverse.io by Ali-Tahmazi99 with skeleton shimmer effect
  if (isLoadingTransition) {
    return (
      <div 
        className="fixed inset-y-0 left-1/2 -translate-x-1/2 w-full max-w-md z-50 flex flex-col bg-white overflow-y-auto no-scrollbar pb-10 text-right select-none animate-none"
        dir="rtl"
      >
        {/* Top Pinned Actions Bar for quick exit during load */}
        <div className="sticky top-0 left-0 right-0 z-45 flex justify-between items-center px-6 h-16 bg-white border-b border-zinc-100/60 shrink-0">
          <button 
            onClick={onClose}
            className="bg-zinc-50 hover:bg-zinc-100 text-zinc-900 p-2.5 rounded-full cursor-pointer active:scale-95 border-0"
            type="button"
          >
            <ArrowRight className="w-5 h-5 stroke-[2.3] text-zinc-500" />
          </button>
          <div className="flex gap-3">
            <div className="bg-zinc-50 w-10 h-10 rounded-full border border-zinc-200/40" />
            <div className="bg-zinc-50 w-10 h-10 rounded-full border border-zinc-200/40" />
          </div>
        </div>

        {/* Centered Clock Loader Area */}
        <div className="flex flex-col items-center justify-center py-8 space-y-5 bg-zinc-50/20 border-b border-zinc-100/60 shrink-0">
          <div className="loader mx-auto">
            <span className="hour"></span>
            <span className="min"></span>
            <span className="circel"></span>
          </div>
          <span className="text-[12.5px] font-black text-zinc-500 tracking-wider animate-pulse pt-2 block">
            جاري تحميل كامل عروض وتفاصيل المنشور الفاخر...
          </span>
        </div>

        {/* High details Right-to-Left Shimmer Skeleton Content below */}
        <div className="px-5 sm:px-6 py-6 space-y-6 max-w-xl mx-auto w-full">
          {/* Shimmer Image Box */}
          <div className="h-44 w-full bg-zinc-100 skeleton-shimmer rounded-2xl" />

          {/* Shimmer Header Title & Subtitle */}
          <div className="space-y-3">
            <div className="h-5 w-2/3 bg-zinc-100 skeleton-shimmer rounded-lg ml-auto" />
            <div className="h-3.5 w-1/2 bg-zinc-100 skeleton-shimmer rounded-lg ml-auto" />
          </div>

          <div className="border-t border-zinc-100/80 my-2" />

          {/* Shimmer Rows */}
          <div className="space-y-5">
            <div className="flex items-center gap-3.5 justify-end">
              <div className="flex-1 space-y-2">
                <div className="h-3.5 bg-zinc-100 skeleton-shimmer rounded-md w-2/5 ml-auto" />
                <div className="h-3.5 bg-zinc-100 skeleton-shimmer rounded-md w-4/5 ml-auto" />
              </div>
              <div className="w-10 h-10 rounded-full bg-zinc-100 skeleton-shimmer shrink-0" />
            </div>

            <div className="flex items-center gap-3.5 justify-end">
              <div className="flex-1 space-y-2">
                <div className="h-3.5 bg-zinc-100 skeleton-shimmer rounded-md w-1/3 ml-auto" />
                <div className="h-3.5 bg-zinc-105 skeleton-shimmer rounded-md w-11/12 ml-auto" />
              </div>
              <div className="w-10 h-10 rounded-full bg-zinc-100 skeleton-shimmer shrink-0" />
            </div>
            ...
            <div className="flex items-center gap-3.5 justify-end">
              <div className="flex-1 space-y-2">
                <div className="h-3.5 bg-zinc-100 skeleton-shimmer rounded-md w-1/4 ml-auto" />
                <div className="h-3.5 bg-zinc-105 skeleton-shimmer rounded-md w-3/4 ml-auto" />
              </div>
              <div className="w-10 h-10 rounded-full bg-zinc-100 skeleton-shimmer shrink-0" />
            </div>
          </div>
      ...
      >
        ...
        {/* Bottom Fixed Reservator Footer */}
          <motion.div 
            ...
            className="fixed sm:absolute bottom-0 left-0 right-0 z-45 w-full flex flex-col pointer-events-none" 
            dir="rtl"
          >
            <div className="pointer-events-auto bg-white/95 backdrop-blur-md border-t border-zinc-200 py-4.5 px-6 flex items-center justify-between shadow-[0_-12px_36px_-15px_rgba(0,0,0,0.12)] rounded-none" dir="rtl">
  ...
  return (
    <div 
      ...
      onTouchMove={handleTouchMove}
      onTouchEnd={handleTouchEnd}
      className="fixed inset-y-0 left-1/2 -translate-x-1/2 w-full max-w-md z-50 flex flex-col bg-white overflow-hidden"
    >
      <div 
        ref={modalRef}
        className="relative bg-white w-full h-full flex flex-col overflow-hidden"
      ...
      >
          ...
          <div className="max-w-sm mx-auto mt-6 space-y-5">
            ...
            <div className="space-y-4 pt-1 select-none" dir="rtl">
              ...
              <button 
                ...
                className="w-full text-center bg-zinc-100/80 hover:bg-zinc-200/60 text-zinc-800 font-bold text-xs py-2.5 px-4 rounded-xl transition-all cursor-pointer mt-3 border border-zinc-200/40"
              >
            ...
            <div className="space-y-4 pt-4 border-t border-zinc-100">
              ...
              {/* Button to open all reviews - "إظهار كل التقييمات البالغ عددها X تقييمًا" */}
              <button
                type="button"
                onClick={() => {
                  triggerHaptic('medium');
                ...
                className="w-full text-center bg-zinc-100/80 hover:bg-zinc-200/60 text-zinc-800 font-bold text-xs py-2.5 px-4 rounded-xl transition-all cursor-pointer mt-3 border border-zinc-200/40"
              >
                إظهار كل التقييمات البالغ عددها {listing.reviewsCount} تقييمًا
              </button>
        ...
        >
          ...
          <div className="pointer-events-auto bg-white/95 backdrop-blur-md border-t border-zinc-200 py-4 px-6 flex items-center justify-between shadow-[0_-12px_36px_-15px_rgba(0,0,0,0.12)] rounded-none" dir="rtl">
        ...
        {/* Full-screen All Reviews page overlay matching standard and user's guidelines */}
        <AnimatePresence>
          {showAllReviewsPage && (
            <AllReviewsPage 
              listing={listing}
              onClose={() => setShowAllReviewsPage(false)}
              language={language}
            />
          )}
        </AnimatePresence>
...
const AmenitiesPage: React.FC<AmenitiesPageProps> = ({ onClose, hostName }) => {
  return (
    <motion.div
      ...
      className="absolute inset-0 bg-white z-50 overflow-y-auto pb-24 flex flex-col text-right scrollbar-none rounded-none"
      dir="rtl"
    >
