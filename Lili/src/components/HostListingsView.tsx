...
export const HostListingsView: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 sm:px-6 pt-10 pb-6 space-y-6 text-right select-none md:pb-28" dir="rtl">
      ...
      <div className="flex items-center justify-between font-black">
        ...
        <div className="flex gap-2.5">
          <button
            ...
            className="w-10 h-10 bg-zinc-100 hover:bg-zinc-200/80 rounded-full flex items-center justify-center transition-all cursor-pointer active:scale-95 text-zinc-900 border border-zinc-200/20 shadow-2xs"
        ...
        <div className="text-center space-y-5 px-4">
          ...
          <div className="pt-2">
            <button
              onClick={() => setShowCreateModal(true)}
              type="button"
              className="bg-zinc-100 hover:bg-zinc-200 transition-all text-zinc-900 text-xs font-black py-3 px-8 rounded-xl cursor-pointer active:scale-95"
            >
              البدء
            </button>
          </div>
            ...
            >
              ...
              {successMsg ? (
                ...
                <form onSubmit={handleCreateListing} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#ff385c] hover:bg-rose-600 text-white font-black text-xs py-3.5 rounded-xl transition-all active:scale-95 flex items-center justify-center gap-2"
                  >
