...
export const TripsTab: React.FC<TripsTabProps> = ({ onNavigateToExplore }) => {
  return (
    <div className="max-w-md mx-auto px-4 pt-10 pb-6 space-y-5 bg-white text-zinc-900" id="trips-tab-container" dir="rtl">
      ...
      <div className="flex flex-col items-center justify-center space-y-6 pt-4">
        ...
        <div className="pt-2">
          <button
            ...
            className="bg-[#df1e5a] hover:bg-rose-600 text-white font-black text-[14px] py-3 px-8 rounded-2xl shadow-xs transition-all haptic-tap cursor-pointer"
          >
            ابدأ الآن
          </button>
        </div>
