...
export const MessagesTab: React.FC = () => {
  ...
  const goBack = () => setActiveMessageId(null);
  const swipeHandlers = useSwipeBack({ onSwipeBack: goBack });

  return (
    <div className="max-w-md mx-auto px-4 pt-10 pb-6 space-y-5 bg-white text-zinc-900" id="messages-tab-container" dir="rtl">
      
      {activeMessage ? (
        /* ==================== ACTIVE CHAT WORKSPACE (SUB-VIEW) ==================== */
        <div className="space-y-4 animate-page-in swipe-back-panel" {...swipeHandlers}>
          {/* Header Bar */}
          <div className="flex items-center justify-between pb-2.5 border-b border-zinc-100">
            <button
              onClick={goBack}
              className="w-8.5 h-8.5 bg-zinc-100 hover:bg-zinc-200 rounded-full flex items-center justify-center transition-all cursor-pointer haptic-tap"
              title="رجوع"
            >
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#111111] hover:bg-black text-white p-2.5 rounded-xl shadow-sm transition-all haptic-tap shrink-0 cursor-pointer"
        ...
        <div className="space-y-5 animate-fade-in text-right">
          ...
          <div className="flex flex-col items-center justify-center pt-16 pb-20 text-center space-y-4 w-full">
            ...
            <div className="pt-3">
              <button
                onClick={() => setShowArchived(false)}
                className="px-5 py-2 border border-zinc-250 hover:bg-zinc-50 hover:border-zinc-350 haptic-tap text-zinc-900 text-[11px] font-black rounded-lg transition-all cursor-pointer font-sans"
              >
                عرض جميع الرسائل
              </button>
            </div>
        ...
        <div className="space-y-4 animate-fade-in">
          ...
          <div className="flex gap-2 pb-1 justify-start overflow-x-auto scrollbar-none">
            <button
              ...
              className={`font-black px-4.5 py-1.5 sm:py-2 rounded-full text-[12.5px] transition-all cursor-pointer haptic-tap ${
                selectedPill === 'all'
                    ...
                    <div className="pt-4 border-t border-zinc-150/80 flex items-center justify-between mt-4">
                      ...
                      <button
                        ...
                        className={`px-6 py-2 rounded-xl transition-all font-black text-[12px] cursor-pointer ${
                          feedbackOptionSelected
                            ? 'bg-[#111111] text-white hover:bg-black haptic-tap shadow-sm'
                  ...
                  <div className="py-8 text-center space-y-4 animate-fade-in text-right">
                    ...
                    <div className="pt-3 text-center">
                      <button
                        ...
                        className="px-6 py-2 bg-zinc-900 hover:bg-black text-white text-[11px] font-black rounded-lg transition-all haptic-tap cursor-pointer"
                      >
                        إغلاق
                      </button>
                    </div>
