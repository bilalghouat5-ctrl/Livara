...
export const FavoritesTab: React.FC<FavoritesTabProps> = ({ onNavigateToExplore }) => {
  ...
  if (activeFolder === 'recent') {
    ...
    return (
      <div className="max-w-md mx-auto px-4 pt-10 pb-6 bg-white text-zinc-900" id="favorites-details-container" dir="rtl">
        ...
        <div className="flex items-center justify-between pb-4">
          ...
          <button
            ...
            className="w-10 h-10 bg-zinc-100 hover:bg-zinc-200 rounded-full flex items-center justify-center transition-all cursor-pointer haptic-tap"
            title="رجوع"
          >
          ...
          <button
            ...
            className={`font-extrabold px-4 py-1.5 rounded-full text-[12px] transition-all cursor-pointer haptic-tap ${
              isEditing 
          ...
          <div className="w-full text-right pt-4 space-y-6">
            ...
            <div className="flex justify-start">
              <button
                ...
                className="bg-[#222222] hover:bg-black text-white font-black text-[14px] px-7 py-3 rounded-2xl shadow-sm transition-all haptic-tap cursor-pointer"
              >
                بدء الاستكشاف
              </button>
            </div>
                        ...
                        <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-zinc-50 border border-zinc-100/65 shadow-xs">
                          ...
                          {!isEditing && (
                            <button 
                              ...
                              className="absolute top-2 left-2 z-10 bg-transparent text-white hover:scale-110 haptic-tap transition-all outline-none"
                            >
  ...
  return (
    <div className="max-w-md mx-auto px-4 pt-10 pb-6 space-y-5 bg-white text-zinc-900" id="favorites-tab-container" dir="rtl">
