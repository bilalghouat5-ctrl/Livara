    ...
    <div className="w-full max-w-md mx-auto px-4 sm:px-6 pt-10 pb-6 space-y-6 text-right select-none md:pb-28" dir="rtl">
      ...
      <div className="flex justify-between items-center pr-1.5">
        ...
        <div className="flex gap-2">
          <button className="w-9 h-9 bg-zinc-100 hover:bg-zinc-200/75 rounded-full flex items-center justify-center transition-all cursor-pointer active:scale-95 text-zinc-800">
          ...
          <div className="border-t border-zinc-200/50 pt-3.5 flex sm:flex-row flex-col gap-2">
            {!bookedDates.includes(selectedDate) ? (
              <button
                ...
                className={`py-3.5 px-5 rounded-xl font-black text-xs cursor-pointer select-none active:scale-95 transition-all w-full flex items-center justify-center gap-2 ${
