...
export const ExploreTab: React.FC = () => {
  const { listings, favorites, toggleFavorite, setSelectedListing, searchTerm, setSearchTerm, selectedWilaya, setSelectedWilaya, userProfile, updateUserProfile } = useApp();
  ...
  // 1. Toast Notification States - DISABLED BY USER REQUEST
