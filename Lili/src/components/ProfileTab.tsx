          ...
          <div className="space-y-5 animate-fade-in" id="profile-subview-settings" dir="rtl">
            ...
            {!settingsSubSection ? (
              ...
              <div className="space-y-5 animate-fade-in">
                ...
                <div className="pt-8 flex flex-col items-end justify-start gap-1.5 pr-4 animate-fade-in" dir="rtl">
                  <span className="text-[11px] font-sans font-bold text-zinc-400 tracking-wide leading-none">
                    Version 6.7.34
                  </span>
                  <div className="flex items-center gap-1.5 mt-0.5 select-none" dir="ltr">
                    <div className="w-5.5 h-5.5 flex items-center justify-center shrink-0">
                      <svg className="w-5 h-5 text-[#c5a85c]" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="11" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M 18,82 L 50,18 L 82,82" />
                        <path d="M 32,54 L 68,54" strokeWidth="9" />
                      </svg>
                    </div>
                    <span className="text-[13px] font-sans font-black tracking-tight flex items-center gap-1 select-none">
                      <span className="text-[#c5a85c]">Asirem</span>
                      <span className="text-zinc-400 font-bold">CORP.</span>
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6" id="profile-subview-card">
            ...
            <div className="max-w-md mx-auto bg-zinc-900 text-white rounded-[2rem] p-6 shadow-xl relative overflow-hidden border border-zinc-800">
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="font-sans font-black text-lg tracking-widest text-rose-500 uppercase">LACASA</h3>
