...
// 1. HIGH-FIDELITY WEB HARWARE AUDIO SYNTHESIS FOR IMMERSIVE HAPTIC FEEDBACK
export const playHapticSound = (type: 'tap' | 'heavy' | 'sucess' | 'success' | 'select' | 'pull') => {
  ...
  try {
    ...
    if (type === 'tap' || type === 'select') {
      ...
      osc.type = 'sine';
      osc.frequency.setValueAtTime(type === 'select' ? 520 : 450, ctx.currentTime);
    ...
    } else if (type === 'sucess' || type === 'success') {
      // High-low-high bell synth
      ...
      gain2.gain.setValueAtTime(0.03, ctx.currentTime + 0.04);
      gain2.gain.exponentialRampToValueAtTime(0.001, ctx.currentTime + 0.3);
      
      osc1.start(); osc1.stop(ctx.currentTime + 0.25);
    ...
    // Audio Context is not initialized/supported
  }
};
